...
<!----------------------changed---------------------------------------------->
	<header>
		<div><a href="">sign in</a> | <a href="">sign up</a></div>
	</header>
  <h1 class="title">Loyly</h1>
  <div class="search_form">
    <form>

      <input type="text" name="massageSearchWhat" placeholder="What" id = "whatMassageDropDown">
	  <input type="text" name="massageSearchWhen" placeholder="When" id = "whenMassageDropDown">
      <input type="text" name="massageSearchWhere" placeholder="Where" id = "whereMassageDropDown">
	  <input type="image" id="search_button" src="../IMGs/Apps-Search-icon.png" border="0" alt="Submit" height="30" width="30"/>
    </form>
	<!---------------------end-change--------------------->
  </div>
  ...
  <footer>
    <div class="centered clearfix">
      ...
      <address class="footer-contact">
         ...
         <p><a href="mailto:">info@goloyly.com</a></p>
         <p><a href="tel:">123-456-7890</a></p>
         <p><a href="">123 Fake St<br />Fake, PA 11111</a></p>
      </address>
      <div class="footer-navigation">
        <div class="footer-links-holder">
          <h3><a href="">Popular Treatments</a></h3>
          <ul class="footer-links">
            <li><a href = "goloyly.com/about">Birthday Foot Massage</a></li>
            <li><a href = "goloyly.com/faq">Sweedish Massage</a></li>
            <li><a href = "goloyly.com/privacy">Deep Tissue Massage</a></li>
            <li><a href = "goloyly.com/terms">See All</a></li>
          </ul>
        </div>
        <div class="footer-links-holder">
          <h3><a href="">Locations</a></h3>
          <ul class="footer-links">
            <li><a href="">Tel Aviv Massage</a></li>
            <li><a href="">Israel Massage</a></li>
            <li><a href="">Amsterdam Massage</a></li>
            <li><a href="">Netherlands Massage</a></li>
          </ul>
        </div>
        <div class="footer-links-holder">
